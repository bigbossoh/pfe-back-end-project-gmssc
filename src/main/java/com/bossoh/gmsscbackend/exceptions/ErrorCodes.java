...
public enum ErrorCodes {
    ...
    TODOACTION_NOT_VALID(15000),
    TODOACTION_NOT_FOUND(15001),
    TODOACTION_ALREADY_EXISTS(15002),
    CORRECTIVE_NOT_VALID(16000),
    CORRECTIVE_NOT_FOUND(16001),
    CORRECTIVE_ALREADY_EXISTS(16002),
